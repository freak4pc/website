...
const Share = ({ url, description }) => {
  return (
    <div>
      ...
      <a
        className="resp-sharing-button__link"
        href={`mailto:?subject=${encodeURI(description)}&amp;body=${encodeURI(
          url
        )}`}
        target="_self"
        aria-label=""
      ...
      <a
        className="resp-sharing-button__link"
        href={`https://www.linkedin.com/shareArticle?mini=true&amp;url=URL&amp;title=${encodeURI(
          description
        )}&amp;summary=${encodeURI(description)}&amp;source=${encodeURI(url)}`}
        target="_blank"
        aria-label=""
      >
      ...
      <a
        className="resp-sharing-button__link"
        href={`https://telegram.me/share/url?text=${encodeURI(
          description
        )}&amp;url=${encodeURI(url)}`}
        target="_blank"
        aria-label=""
